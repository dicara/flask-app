...
from bioweb_api.apis.ApiConstants import RESULT, PLOT
...
# Class
#=============================================================================
class IdentityDeleteFunction(AbstractDeleteJobFunction):
    ...
    @staticmethod
    def summary():
        return "Delete secondary analysis identity jobs."
...
if __name__ == "__main__":
    function = IdentityDeleteFunction()
    print function